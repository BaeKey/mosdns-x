    ...
    for env in envs:
        ...
        try:
            subprocess.check_call(
                f'go build -ldflags "-s -w -buildid= -X github.com/BaeKey/mosdns-x/constant.Version={VERSION} -X github.com/BaeKey/mosdns-x/constant.BuildTime={BuildTime}" -trimpath -o {bin_filename} ../', shell=True,
                env=os_env)
